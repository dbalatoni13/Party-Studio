        ...
        public class AnimationWrapper : STAnimation, IEditableAnimation
        {
            ...
            private void Replace()
            {
                ...
                if (dlg.ShowDialog())
                {
                    ...
                    {
                        var anim = HSFJsonAnimationConverter.Import(System.IO.File.ReadAllText(dlg.FilePath));
                        Anim.AnimGroups.Clear();
                        Anim.AnimGroups.AddRange(anim.AnimGroups);
                        Anim.trackInfo.Clear();
                        Anim.trackInfo.AddRange(anim.trackInfo);
                        Anim.FrameCount = anim.FrameCount;
                    }
                    Json = HSFJsonAnimationConverter.Export(Anim);
                }
            }
